...
def cargar_imagenes(carpeta):
    ...
    for archivo in archivos_imagen:
        ...
        imagen.thumbnail((200, 200))  # Ajustar el tamaño de la miniatura
...
slider_filas = tk.Scale(root, from_=1, to=10, orient=tk.HORIZONTAL, label="Número de Filas", command=actualizar_grid)
slider_filas.set(4)  # Valor inicial
slider_filas.pack(pady=10)
